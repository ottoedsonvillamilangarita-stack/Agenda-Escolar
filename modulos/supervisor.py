...
def mostrar(data):
    ...
    supervisor = response.json()[0] if response.status_code == 200 else data
    ...
    usuario_completo = {
        "id_persona": supervisor["id_persona"],
    ...
    with tab_supervision:
        ...
        st.info("Próximamente: reportes detallados y supervisión de actividades")
